document.addEventListener("DOMContentLoaded", () => {
    ...
    const bioContent = {
        early: `<h2>Πρώτα Χρόνια</h2><p>Ο Μίλτος Τεντόγλου γεννήθηκε στις 18 Μαρτίου 1998 στην Γρεβενά. Από μικρή ηλικία έδειξε ιδιαίτερο ταλέντο στον αθλητισμό και ξεκίνησε την ενασχόλησή του με το άλμα εις μήκος στην εφηβεία. Η οικογένειά του και οι προπονητές του αναγνώρισαν νωρίς το ταλέντο του και τον υποστήριξαν να ακολουθήσει την αθλητική καριέρα.</p>`,
